...
const build = Path.join(__dirname, '/dist_/');


// if (Fs.existsSync(Path.join(__dirname, '/dist_')))
//     Fs.rmdirSync(Path.join(__dirname, '/dist_'))

Fs.mkdirSync(Path.join(__dirname, '/dist_'));
